...
def get_patient():
    ...
    try:
        ...
        patient = mongo.db["Dimentia-detection-system-Patient"].find_one(
            ...
            {"_id": 0, "patient_name": 1, "patient_history": 1, "age": 1, "sex": 1, "images": 1}
        )
        if patient:
...
def predict():
    ...
    try:
        ...
        patient = mongo.db["Dimentia-detection-system-Patient"].find_one({"patient_id": patient_id})
        ...
        mongo.db["Dimentia-detection-system-Patient"].update_one(
            {"patient_id": patient_id},
