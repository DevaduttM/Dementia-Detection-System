    ...
    <Navbar />
      ...
      className="h-screen w-screen bg-[#f1e4e4] flex md:justify-center justify-end md:gap-10 gap-5 items-center flex-col overflow-y-scroll">
        ...
        <div className="md:w-[80%] sm:w-[70%] w-[90%] md:h-[60%] h-[80%] bg-[#fafaf6] rounded-xl shadow-2xl mt-[5rem] flex items-center justify-around md:flex-row flex-col">
          ...
          <input onChange={(e) => setPatientId(e.target.value)} type="text" required placeholder="Patient ID" className="w-[90%] md:w-full h-[3rem] border-dashed border-[1px] border-[#525252a9] px-3 bg-gray-100 text-black rounded-xl focus:border-none focus:outline-dashed" />
          <div
        ...
        <button className="w-[10rem] h-[3rem] bg-[#4a56c0] rounded-xl text-white mb-5 md:mb-0" onClick={handleSubmit}>Submit</button>
      </motion.div>
    {submitted === 1 && 
